...
from model_ocr.model_paddle import perform_ocr
from model_ocr.model_vietocr import perform_vietocr

from surya.detection import batch_text_detection
from surya.input.processing import slice_polys_from_image, slice_bboxes_from_image, convert_if_not_rgb, slice_polys_from_image_v2
...
def evaluate_ocr(images: List[Image.Image], langs: List[List[str]], det_predictions, rec_model, rec_processor, batch_size=None) -> List[OCRResult]:
    all_slices = []
    slice_map = []
    all_langs = []
    all_slices_crop = []
